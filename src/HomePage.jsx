    ...
    <MainContainer>
      <Header>
        ...
        <Description>
          ...
          주요 항목으로는 참가자 지원, 홍보 활동, 행사 운영비 등이 있으며, 각 항목은 해커톤의 성공적인 개최를 위한 필수 요소들을 반영한 것입니다 :) 
        </Description>
      </Header>
      <ContentContainer>
        <BudgetSection>
          <BudgetHeader>잔여 예산</BudgetHeader>
          <BudgetAmount>1,243,800 <span>원</span></BudgetAmount>
          ...
          <ChartContainer>
            ...
            <ChartTextContainer>
              {data.datasets[0].data.map((percentage, index) => (
                <PercentageCircle key={index} style={{ top: `${index * 30 + 10}%`, left: index === 0 ? '60%' : '20%' }}>
